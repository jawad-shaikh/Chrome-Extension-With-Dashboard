...
[Get it now - it's free!](https://chrome.google.com/webstore/detail/ScreenRecorder-screen-recorder/kbbdabhdfibnancpjfhlkhafgdilcnji)
...
Also available for [Microsoft Edge](https://microsoftedge.microsoft.com/addons/detail/ScreenRecorder-screen-record/nbdkgeeeabnfegekngimpknhnkmocjcj)

## Table of contents
  - [Features](#features)
  - [Translating ScreenRecorder to other languages](#translating-ScreenRecorder-to-other-languages)
  - [Self-hosting ScreenRecorder](#self-hosting-ScreenRecorder)
...
[Here's a Google Sheet](https://docs.google.com/spreadsheets/d/1juc1zWC2QBxYqlhpDZZUNHl3P6Tens6YiChchFcEJVw/edit?usp=sharing) to compare ScreenRecorder's features with other free & premium screen recorders available for Chrome.

## Translating ScreenRecorder to other languages
If you'd like to translate ScreenRecorder to a new language, here's what you should do:

1. Make sure the language you want to translate ScreenRecorder into is supported by the Chrome Store. [Here's a list](https://developer.chrome.com/docs/webstore/i18n/#choosing-locales-to-support) of all the supported locales.
2. Create a new folder under [_locales](https://github.com/alyssaxuu/ScreenRecorder/tree/master/_locales) with the [locale name for your language](https://developer.chrome.com/docs/webstore/i18n/#choosing-locales-to-support).
3. Make a copy of [this file](https://github.com/alyssaxuu/ScreenRecorder/blob/master/_locales/en/messages.json) and translate the "message". The "description" shouldn't be translated, it's only there to give you some context where the string will show in the extension.
4. Translate the [Chrome Store description](https://chrome.google.com/webstore/detail/ScreenRecorder-screen-recorder/kbbdabhdfibnancpjfhlkhafgdilcnji?hl=en&authuser=0) so it can be published there, you can simply make a comment with it when you make a pull request. [Here's an example](https://github.com/alyssaxuu/ScreenRecorder/pull/39) of how that pull request should look like.
...
## Self-hosting ScreenRecorder
You can run ScreenRecorder locally without having to install it from the Chrome Store. Here's how:
...
4. That's it, you will now be able to use ScreenRecorder locally. Make sure you pin it on the toolbar by clicking the "puzzle" icon in the toolbar and pinning ScreenRecorder.
