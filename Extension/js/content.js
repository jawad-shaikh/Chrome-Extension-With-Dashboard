$(document).ready(function () {
  const uniqueid = "ScreenRecorder-screen-recorder-extension";
  var recording = true;
  ...
  function injectCode(inject, active) {
    if (inject) {
      ...
      var iframeinject =
        ...
        "' class='noselect'></div><div id='change-size' class='camera-hidden'><div id='small-size' class='size-active choose-size'></div><div id='medium-size' class='choose-size'></div><div id='large-size' class='choose-size'></div><div style='display:none' id='xlarge-size' class='xld choose-size'></div></div></div><div id='wrap-iframe' class='notransition'><iframe src='" +
      ...
      // Inject the toolbar
      var toolbarinject = `<div id="color-pckr-thing"></div><div id="pen-slider" class="toolbar-inactive"><input type="range" min=1 max=50><img class="slider-track" src= 
  ...
  function cameraSize(id) {
    if (id == "xlarge-size") {
      console.log("I RAN");
      $(
        "#ScreenRecorder-screen-recorder-extension #wrap-iframe,#ScreenRecorder-screen-recorder-extension #detect-iframe"
      ).css("border-radius", "5px");
      var widthR = parseFloat(document.documentElement.clientWidth);
      var heightR = parseFloat(document.documentElement.clientHeight);
      console.log("initial Width", widthR);
      console.log("initial heightR", heightR);
      var valW = parseInt(percentageOff(widthR, 10) + "");
      var valH = parseInt(percentageOff(heightR, 10) + "");
      console.log("initial valW", valW);
      console.log("initial valH", valH);
      var leftW = widthR - valW;
      var TH = heightR - valH;
      console.log("initial leftW", leftW);
      console.log("initial TH", TH);

      var valWs = valW + "px";
      var valHs = valH + "px";
      console.log("initial valWs", valWs);
      console.log("initial valHs", valHs);
      var leftWl = parseInt(leftW / 2) + "px";

      var TopHl = parseInt(TH / 2) + "px";
      console.log("initial leftWl", leftWl);
      console.log("initial TopHl", TopHl);
