            ...
            <div class="video-info-section">
              ...
              <div class="comment-interaction">
                ...
                <form class="form-comment">
                  ...
                  <input type="hidden" class="userName" value="<?php if (isset($_COOKIE["user_id"]) && isset($_COOKIE["session_id"]) && isset($_COOKIE["userName"])) {
                  ...
                  <input type="hidden" class="userID" value="<?php if (isset($_COOKIE["user_id"]) && isset($_COOKIE["session_id"]) && isset($_COOKIE["userName"])) {
